...
/**
 * Module dependencies. express构建项目 express -e ejs 项目名字
 */
...
app.configure(function(){
    ...
    //app.set('view engine', 'ejs');
    app.use(flash());//它保存的变量只会在用户当前和下一次的请求中被访问，之后会被清除通过它我们可以很方便地实现页面的通知和错误信息显示功能。
    app.use(express.favicon());//导航栏图标
...
routes(app);//随着页面越来越多此处会越来越长，所以提取到其他页面下
